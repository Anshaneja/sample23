...
function getSteps() {
  return [
    "Association with Punjabi University ",
    "Basic information",
    "Present Profession",
  ];
}
      ...
      <div className="mt-10">
        ...
        <div className="flex flex-row gap-4 justify-center" >
          <div className="flex flex-col">
            <h6 className=" text-center">Year of Joining</h6>
            <TextField
              id="outlined-number"
              label="From"
              type="number"
          ...
          <div className="flex flex-col">
            <h6 className="text-center">Year of Leaving</h6>
            <TextField
              id="outlined-number"
              label="From"
              type="number"
        ...
        {degree.map((one) => {
          return (<>
            ...
            <h6>Example :- Degree or certificate verifying your association with Uni.</h6>
            <TextField
              fullWidth
              type="file"
              label="Proof of Assosiation"
              name="url"
              variant="outlined"
              focused
              margin="normal"
        ...
        <div className="flex flex-row gap-2 justify-end">
          <Button variant="contained" onClick={removeDegree} color="error">Remove</Button>
          <Button variant='contained' margin="normal" onClick={addDegree} >+Add More Degree</Button>
        </div>
      </div>
    </>
  );
...
const BasicInfo = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-row gap-4 justify-center">
        ...
        <div className="flex flex-col w-full">
          <TextField
            ...
            fullWidth
          />
          <p className="font-light">For office use only</p>
        </div>
      </div>
      <TextField
      type="file"
      ...
      <h6 className="pt-2">Social Media Accounts</h6>
        ...
        {addOccupation.map((one) => {
          return (<>
            ...
            <TextareaAutosize
              ...
              minRows={2}
              placeholder="if your are presently serving Please describe"
              fullWidth
              margin="normal"
...
const SignUp = () => {
  ...
  return (
    ...
    <div className=" flex flex-row gap-4 justify-evenly ">
      <div className="w-3/4 mt-[8rem]">
        <h3 className="font-normal text-xl text-left p-3 ml-12 ">
      ...
      <ol className=" list-inside list-decimal text-left space-x-4">
        <li className="ml-4">A person may become a patron of this Association by donating a sum of at least of Rs. 50,000/- or moreÂ (NRI/Overseas : US$ 10,000 or equivalent with approval of the Chief Patron)</li>
        <li>Donor Member: by donating Rs. 20,000/- or more (NRI/Overseas : US$ 4000 or equivalent)</li>
        <li>Life Member: Rs. 1000/- (NRI/Overseas : US$ 100 or equivalent).</li>
        <li>Ordinary Member: Rs. 100 per annum (financial year basis).</li>
