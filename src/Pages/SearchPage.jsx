    ...
    return (
        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            ...
            {/* Search Component */}
            <div className="py-4 mt-3 flex flex-col items-center  bg-blue-700">
                        ...
                        <div className="">
                            ...
                            <div className="" ref={regNoList}>
                                <ul className=" flex flex-col gap-2 w-full">
                                    <li>
                                    <input type="text" className="py-1 px-2 outline rounded outline-gray-400 outline-[1px] focus:outline-2 focus:outline-blue-500" onChange={(e) => setRegNo(e.target.value)} value={regNo}  placeholder="RegNo" />
                                    </li>
